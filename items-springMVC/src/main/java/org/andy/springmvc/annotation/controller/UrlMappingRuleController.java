...
public class UrlMappingRuleController {
    ...
    public void templateUrlMapping(HttpServletRequest request, HttpServletResponse response) throws IOException {
        response.getWriter().write("template url mapping rule, url : " + UrlUtil.getURL(request));
    }
...
//    @RequestMapping(value = "/ant/**/{paramOne}")
    ...
    public void regularUrlMapping(HttpServletRequest request, HttpServletResponse response) throws IOException {
        response.getWriter().write("regular url mapping rule, url : " + UrlUtil.getURL(request));
    }
