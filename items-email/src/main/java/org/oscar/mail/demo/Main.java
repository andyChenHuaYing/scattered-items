...
public class Main {
    ...
    public static void main(String[] args) throws MessagingException, IOException {
        ...
        sendMessageToAddress(simpleMessage, "461857202@qq.com");
        Message messageWithAttachment = buildMessageWithAttachment(session);
        sendMessageToAddress(messageWithAttachment, "461857202@qq.com");
        Message withImage = buildMessageWithEmbeddedImage(session);
        addressAndSendMessage(withImage, "461857202@qq.com");
    }
