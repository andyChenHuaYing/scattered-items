...
public class Code03_Heap02 {
    ...
    public static class MyHeap<T> {
        ...
        private void heapInsertMock(int index) {
            while (comparator.compare(heap.get(index), heap.get((index - 1) / 2)) < 0) {
                swapMock(index, (index - 1) / 2);
				index = (index - 1) / 2;
            }
        }
        ...
        private void swapMock(int i, int j) {
            T o1 = heap.get(i);
            T o2 = heap.get(j);
            heap.set(j, o1);
            heap.set(i, o2);
